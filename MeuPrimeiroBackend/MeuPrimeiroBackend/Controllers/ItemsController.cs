...
namespace MeuPrimeiroBackend.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,Nome,Descricao,Altura,Peso,TipoItemID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,Nome,Descricao,Altura,Peso,TipoItemID")] Item item)
        {
            if (ModelState.IsValid)
            {
